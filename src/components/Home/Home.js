...
import SalesBar from '../SalesBars/SalesBar';
...
const Home = () => {
    ...
    return (
        <div>
            <Carousel></Carousel>
            <div className='mx-3'>
                <h1 className='text-xl lg:text-2xl my-8'>Welcome to <span className='font-bold'>VitaPure</span> WMS(Warehouse Management System)</h1>
