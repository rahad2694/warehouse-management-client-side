...
const Footer = () => {
    return (
        <div>
            <footer className="text-center lg:text-left bg-custom-orange text-gray-600">
                <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                    <div className="mr-12 hidden lg:block">
                        <span>Ping us on social networks:</span>
                    </div>
                    <div className="flex justify-center">
                        <a href="#!" className="mr-6 text-gray-600 hover:text-white">
                    ...
                    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="">
                            <h6 className=" uppercase font-semibold mb-4 flex items-center justify-center md:justify-start">
                                <img src="https://i.ibb.co/Ttmy7BR/logo.png" style={{ "height": "60px" }} alt=""
                                    loading="lazy" />
                                <p className='text-2xl font-bold ml-2 mr-1 font-Brush'>VitaPure</p>
                            </h6>
                            <p>
                                VitaPure is one of the largest and oldest Fresh fruit provider in Bangladesh. We are serving since 1996
                            </p>
                        </div>
                        <div className="">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Strawberries</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Mangoes</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Pineapples</a>
                            </p>
                            <p>
                                <a href="#!" className="text-gray-600">Guavas</a>
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Orders online</a>
                            </p>
                            <p>
