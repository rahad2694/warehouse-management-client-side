...
const Footer = () => {
    return (
        <div>
            <footer class="text-center lg:text-left bg-custom-orange text-gray-600">
          ...
          ">
                                ...
                                <h1 className='text-2xl font-bold ml-2 mr-1 font-Brush'>VitaPure</h1>
                            </h6>
                            <p>
                ...
                <div class="text-center p-3 bg-gray-200">
                    <span>© 2022 Copyright: </span>
                    <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> VitaPure</a>
                </div>
            </footer>
        </div>
    );
